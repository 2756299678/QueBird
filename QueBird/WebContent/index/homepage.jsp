  ...
  <tr>
    <td><table width="1300" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td width="120"><a href="${pageContext.request.contextPath}/user/userself.jsp" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image7','','../images/index2_42.png',1)"><img src="../images/index2_4.png" name="Image7" width="120" height="40" border="0" id="Image7" /></a></td>
