...
public class UserDao {
	...
	{
		String sql="insert into  admin(username,password,salt,nickname,picture,sex,age,edugrade,datetime) values('"+userBean.getUsername()+"','"+userBean.getPassword()
		+"','"+userBean.getSalt()+"','"+userBean.getNickname()+"','"+userBean.getPicture()+"','"+userBean.getSex()+"','"+userBean.getAge()+"','"+userBean.getEdugrade()
	...
	//用户申请
		...
		{
			String sql="insert into  [user](username,password,salt,nickname,picture,sex,age,edugrade,datetime) values('"+userBean.getUsername()+"','"+userBean.getPassword()
			+"','"+userBean.getSalt()+"','"+userBean.getNickname()+"','"+userBean.getPicture()+"','"+userBean.getSex()+"','"+userBean.getAge()+"','"+userBean.getEdugrade()
			+"',getdate())";
			Connection conn=DBUtil.getConn();
			boolean f=false;
		...
		{
			String sql="update [user] set username='"+userBean.getUsername()+"',password='"+userBean.getPassword()+"',salt='"+userBean.getSalt()
			+"',status='"+userBean.getStatus()+"',nickname='"+userBean.getNickname()+"',picture='"+userBean.getPicture()+"',sex='"+userBean.getSex()
			+"',age='"+userBean.getAge()+"',edugrade='"+userBean.getEdugrade()+"' where id='"+userBean.getId()+"'";
			Connection conn=DBUtil.getConn();
			boolean f=false;
